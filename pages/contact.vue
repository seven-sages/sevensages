<template>
  <div class="bg-white dark:bg-gray-800 py-6 sm:py-8 lg:py-12">
    ...
    <div class="mb-10 md:mb-16">
      <h2 class="mb-4 text-center text-2xl font-bold text-gray-800 dark:text-white md:mb-6 lg:text-3xl">Get in touch</h2>
    </div>
    <!-- text - end -->
    ...
    <form class="mx-auto grid max-w-screen-sm gap-4 sm:grid-cols-2">
      <div>
        <label for="first-name" class="mb-2 inline-block text-sm text-gray-800 dark:text-gray-200 sm:text-base">Name</label>
      ...
      <div>
        <label for="email" class="mb-2 inline-block text-sm text-gray-800 dark:text-gray-200 sm:text-base">Email*</label>
      ...
      <div class="sm:col-span-2">
        <label for="subject" class="mb-2 inline-block text-sm text-gray-800 dark:text-gray-200 sm:text-base">Subject*</label>
      ...
      <div class="sm:col-span-2">
        <label for="message" class="mb-2 inline-block text-sm text-gray-800 dark:text-gray-200 sm:text-base">Message*</label>
