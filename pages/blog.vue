    ...
    <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
      ...
      >
        ...
        <div class="flex flex-col overflow-hidden rounded-lg border bg-white">
          ...
          >
            <img
              src="https://sp-ao.shortpixel.ai/client/q_glossy,ret_img,w_370/https://ssd-conf.org/wp-content/uploads/2016/06/blog-thumb-placeholder.jpg"
              loading="lazy"
          ...
          <div class="flex flex-1 flex-col p-4 sm:p-6">
            ...
            <p class="mb-8 text-gray-500">
              ...
              Pellentesque efficitur laoreet eros tincidunt laoreet. Nullam a
              pretium tellus, id tempor ex. Ut commodo lectus sit amet volutpat
              pretium.
            </p>
